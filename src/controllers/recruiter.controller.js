...
export { filterCandidates, downloadCv, getDownloadCount, shortlist, createRecruiter, deleteRecruiter };

export default { filterCandidates, downloadCv, getDownloadCount, shortlist, createRecruiter, deleteRecruiter };
